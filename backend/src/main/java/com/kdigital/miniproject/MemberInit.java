...
public class MemberInit implements ApplicationRunner{
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		Optional<Member> admin =memberRepo.findByUserid("administrator");  
		if(admin.isEmpty())
		{
		...
		if(fishDRepo.findByNameAndDetailIsNotNull("감성돔") == null)
			fishDRepo.save(FishDetail.builder()
					...
					.build());
//		if(fishDRepo.findByNameAndDetailIsNotNull("기타어종") == null)
//			fishDRepo.save(FishDetail.builder()
//					.name("기타어종")
...
//					.build());
		if(fishDRepo.findByNameAndDetailIsNotNull("농어") == null)
			fishDRepo.save(FishDetail.builder()
					.name("농어")
					...
					.build());
		if(fishDRepo.findByNameAndDetailIsNotNull("돌돔") == null)
			fishDRepo.save(FishDetail.builder()
					.name("돌돔")
					...
					.build());
		if(fishDRepo.findByNameAndDetailIsNotNull("우럭") == null)
			fishDRepo.save(FishDetail.builder()
					.name("우럭")
					...
					.build());
		if(fishDRepo.findByNameAndDetailIsNotNull("참돔") == null)
			fishDRepo.save(FishDetail.builder()
					.name("참돔")
					.detail("도미과의 물고기이다.")
					...
					.build());
		if(fishDRepo.findByNameAndDetailIsNotNull("벵어돔") == null)
			fishDRepo.save(FishDetail.builder()
					.name("벵어돔")
					...
					.build());
		if(fishDRepo.findByNameAndDetailIsNotNull("볼락") == null)
			fishDRepo.save(FishDetail.builder()
					.name("볼락")
					...
					.build());
		if(fishDRepo.findByNameAndDetailIsNotNull("열기") == null)
			fishDRepo.save(FishDetail.builder()
					.name("열기")
