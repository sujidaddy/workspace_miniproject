...
public class MemberInit implements ApplicationRunner{
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		if(fishDRepo.findByName("감성돔") == null)
		...
		if(fishDRepo.findByName("기타어종") == null)
			fishDRepo.save(FishDetail.builder()
					.name("기타어종")
					...
					.build());
		if(fishDRepo.findByName("농어") == null)
			fishDRepo.save(FishDetail.builder()
					.name("농어")
					...
					.build());
		if(fishDRepo.findByName("돌돔") == null)
			fishDRepo.save(FishDetail.builder()
					.name("돌돔")
					...
					.build());
		if(fishDRepo.findByName("우럭") == null)
			fishDRepo.save(FishDetail.builder()
					.name("우럭")
					...
					.build());
		if(fishDRepo.findByName("참돔") == null)
			fishDRepo.save(FishDetail.builder()
					.name("참돔")
					.detail("도미과의 물고기이다.")
					...
					.build());
		if(fishDRepo.findByName("벵어돔") == null)
			fishDRepo.save(FishDetail.builder()
					.name("벵어돔")
					...
					.build());
		if(fishDRepo.findByName("볼락") == null)
			fishDRepo.save(FishDetail.builder()
					.name("볼락")
					...
					.build());
		if(fishDRepo.findByName("열기") == null)
			fishDRepo.save(FishDetail.builder()
					.name("열기")
